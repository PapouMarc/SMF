...
function db_extend($type = 'extra')
{
	...
	require_once($sourcedir . '/Db' . strtoupper($type[0]) . substr($type, 1) . '-mariadb.php');
...
function smf_db_get_server_info($connection = null)
{
	...
	//return only mysql version equivalent
	return explode("-",explode("-MariaDB-", mysqli_get_server_info($connection === null ? $db_connection : $connection))[0])[0];
}
